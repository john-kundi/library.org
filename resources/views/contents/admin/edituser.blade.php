                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ $user->name }}" name="fname" class="form-control" required/>
                                                </div><!-- form-group -->
                                            </div><!-- col-sm-6 -->
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ $user->lname }}" name="lname" class="form-control" required/>
                                                </div><!-- form-group -->
                                            </div><!-- col-sm-6 -->
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="mail" value="{{ $user->email }}" name="email" class="form-control" required/>
                                                </div><!-- form-group -->
                                            </div><!-- col-sm-6 -->
                                        </div><!-- row -->
