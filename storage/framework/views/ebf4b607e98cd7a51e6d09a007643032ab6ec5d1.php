...
<html lang="en">
    ...
    <form action="<?php echo e(route('admin.update.book',$book->id)); ?>" method="post" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="<?php echo e($book->name); ?>" name="bookname" class="form-control" />
                                                </div><!-- form-group -->
                                            </div><!-- col-sm-6 -->
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="<?php echo e($book->author); ?>" name="author" class="form-control" />
                                                </div><!-- form-group -->
                                            </div><!-- col-sm-6 -->
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="<?php echo e($book->code); ?>" name="code" class="form-control" />
                                                </div><!-- form-group -->
                                            </div><!-- col-sm-6 -->
                                        </div><!-- row -->
...
<?php /**PATH C:\Users\GJB STAFF\Desktop\library\resources\views/contents/admin/bookeditform.blade.php ENDPATH**/ ?>