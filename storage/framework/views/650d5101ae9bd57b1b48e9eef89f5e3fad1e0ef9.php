                                ...
                                <div class="thmb">
                                  ...
                                  <div class="btn-group fm-group">
                                      ...
                                      <ul class="dropdown-menu fm-menu pull-right" role="menu">
                                        <li><a href="<?php echo e(route('admin.edit.book',$book->id)); ?>"><i class="fa fa-pencil"></i> Edit</a></li>
                                        <li><a href="<?php echo e(route('admin.delete.book',$book->id)); ?>"><i class="fa fa-trash-o"></i> Delete</a></li>
                                      </ul>
                                  </div><!-- btn-group -->
                                  <div class="thmb-prev">
...
<?php /**PATH C:\Users\GJB STAFF\Desktop\library\resources\views/contents/admin/allbooks.blade.php ENDPATH**/ ?>